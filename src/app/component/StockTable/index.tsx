				...
				<div className="flex space-x-2">
					{popularSymbols.map((symbol) => (
						<button
							...
							className="font-bold bg-gradient-to-r from-blue-200 to-green-200 text-gray-700 px-4 py-2 rounded-xl shadow-md hover:from-blue-100 hover:to-green-100 transition focus:outline-none focus:ring-2 focus:ring-blue-300"
						>
							{symbol}
						</button>
					))}
